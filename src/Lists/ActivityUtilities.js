...
export const activityList = [
    ...
    {   //Short Rest
        ...
        effect: [
            { resource: constants.RES_000.name, perSecRatio: 1, baseRatio: 1}
        ],
        multiplier: 1,
        unlocked: false,
        unlockedFrom: [
    ...
    {   //Sleep
        ...
        effect: [
            { resource: constants.RES_000.name, perSecRatio: 2, baseRatio: 2},
            { resource: constants.RES_000.name, maxValue: 50, baseRatio: 50}
        ],
        multiplier: 1,
        unlocked: false,
        unlockedFrom: [
